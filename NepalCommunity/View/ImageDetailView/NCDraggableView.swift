...
class NCDraggableView:NCBaseView {
  ...
  func setUp(){
    ...
    if let imageView = self.imageView{
      ...
      imageView.backgroundColor = NCColors.clear
...
extension NCDraggableView:UIGestureRecognizerDelegate {
