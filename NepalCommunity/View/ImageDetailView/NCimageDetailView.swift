...
protocol NCImageDetailViewDelegate {
...
class NCImageDetailView: NCBaseView {
  ...
  weak var closeBtn:NCImageButtonView?
  
  weak var scrollView:UIScrollView?
  weak var draggableView:NCDraggableView?
  ...
  var delegate:NCImageDetailViewDelegate?{
    didSet{
      self.closeBtn?.delegate = delegate as? NCButtonDelegate
    }
  }
  
  override func didInit() {
    super.didInit()
    self.backgroundColor = NCColors.black
    self.setup()
  ...
  private func setup(){
    ...
    if let scrollView = scrollView{
      let draggableView = NCDraggableView()
    ...
    do{
      ...
      let closeBtn = NCImageButtonView()
...
extension NCImageDetailView: DraggableViewDelegate{
...
extension NCImageDetailView:UIScrollViewDelegate {
